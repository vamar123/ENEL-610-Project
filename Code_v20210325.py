...
*** This version is to plot distribution histogram for n:N match ***
...
TRIAL_PER_PERSON = 20  # For reshaping the face_distance array. BE SURE TO VERIFY IT BEFORE RUNNING!
PERSONS_FOR_TRIAL = 8  # For reshaping the face_distance array. BE SURE TO VERIFY IT BEFORE RUNNING!
NAME_OF_ORIGIN = "Aaron"  # For plot title. BE SURE TO VERIFY IT BEFORE RUNNING!
...
# Automatic color for labels
def name_to_color(name):  # Returns (R, G, B) from name
    # Take 3 first letters, to lower()
    # lower-cased character ord() value rage is 97 to 122, subtract 97, multiply by 8
